			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 97 Man Thiện, Bến Thành, Quận 1</a></li>
						<li><a href=""><i class="fa fa-phone"></i>0982 092 713</a></li>
						@if(Auth::check())
						<li><a href="{{route('signin')}}">Đơn Hàng</a></li>
						@endif
					</ul>
				</div>
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">{{$product['qty']}}*<span>@if($product['price'] == $product['item']->unit_price){{number_format($product['item']->unit_price)}} @else  {{$product['price']}}@endif</span></span>
										</div>
									</div>
								</div>
							@endforeach
